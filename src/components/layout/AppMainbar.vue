  ...
  <header class="bg-white border-b border-neutral-100 px-4 lg:px-6 py-4 shadow-sm">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-2 sm:gap-4">
        ...
        <div class="relative">
          <button 
            class="p-2 sm:p-2.5 bg-neutral-50 rounded-xl hover:bg-neutral-100 transition-colors"
        ...
        <!-- Notification -->
        <button class="p-2.5 bg-neutral-50 rounded-xl hover:bg-neutral-100 transition-colors">
          <svg class="w-5 h-5 text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
