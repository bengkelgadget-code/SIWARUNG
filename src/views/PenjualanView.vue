...
import SmartCameraScanner from '@/components/penjualan/SmartCameraScanner.vue'
...
<template>
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 h-full">
    ...
    <div class="lg:col-span-2 card flex flex-col overflow-hidden !p-0">
      ...
      <!-- Scanner (inline) -->
      <div v-if="showScanner" class="border-b border-neutral-100 shrink-0 bg-neutral-50">
        <SmartCameraScanner
        ...
        />
        <BarcodeScanner
          v-if="scannerType === 'barcode'"
          @scanned="onBarcodeScanned"
          @close="showScanner = false"
        />
        <div v-if="scannerType === 'barcode'" class="p-2 text-center bg-white border-t border-neutral-100">
          <button class="text-xs font-medium text-primary-600 hover:underline" @click="scannerType = 'smart'">
            Kembali ke Kamera Pintar AI
          </button>
        </div>
      </div>
