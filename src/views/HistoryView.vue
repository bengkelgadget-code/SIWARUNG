...
<template>
  <div class="space-y-4">
    <!-- Toolbar -->
    <div class="neumorphic rounded-2xl px-4 py-3 flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between shadow-sm">
    ...
    <!-- Empty State -->
    <div v-if="filteredTransactions.length === 0" class="neumorphic rounded-2xl p-12 text-center text-neutral-400">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
      <div 
        ...
        :key="trx.id"
        class="neumorphic rounded-2xl p-4 hover:border-primary-300 transition-colors cursor-pointer group"
